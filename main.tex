...
\title{Oscilaciones en la Natalidad en Andaluc\'ia 2015}
%
\titlerunning{Hamiltonian Mechanics}  % abbreviated title (for running head)
%                                     also used for the TOC unless
%                                     \toctitle is used
%
\author{Maria N Padilla\inst{1} \and Jaime Jim\'enez-Ruiz \inst{2}
Inma S Garc\'ia \and Laura De la Casa}
%
...
\begin{figure}[h!]
\centering
\includegraphics[width=10cm]{bebe-2.jpg}
\caption{foto bebe}
\end{figure}
...
\begin{figure}[h!]
\centering
\includegraphics[width=5cm]{sonrisa-bebe2.jpg}
\caption{foto bebe}
\end{figure}
...
The results in this section\cite{Mata-Perez2017Nitro-fattyMetabolism.} are a
...
forcing term is a\textbf{ distribution} on the\textit{ circle}:

\begin{itemize}
\item Aspecto importante
\end{itemize}
